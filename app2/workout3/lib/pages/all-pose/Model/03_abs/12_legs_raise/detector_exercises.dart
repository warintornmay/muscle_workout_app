...
import 'package:google_ml_kit_legs_raise/google_ml_kit.dart';
...
class _PoseDetectorViewState extends State<detector_exercises_legs> {
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                //   MaterialPageRoute(
                                //     builder: (context) =>
                                //         //     detector_exercises_plank(
                                //         //   level: widget.level,
                                //         // ),
                                //         counter_cam(
                                //       level: widget.level,
                                //       routePoseName: 'detector_exercises_plank',
                                //     ),
                                //   ),
                                // );
                              },
            ...
            if (documentSnapshot.exists) {
              ...
              if (poseReps != 0) {
                if ((documentSnapshot.data()
                        as Map<String, dynamic>)['legs_raise$level'] ==
                    null) {
                  users.doc(uid).set(
                      {'legs_raise$level': poseReps}, SetOptions(merge: true));
                } else {
                  users.doc(uid).update({'legs_raise$level': poseReps});
                }
              }
            } else {
