...
class _PoseDetectorViewState extends State<detector_exercises_situp> {
            ...
            if (documentSnapshot.exists) {
              ...
              if (poseReps != 0) {
                if ((documentSnapshot.data()
                        as Map<String, dynamic>)['sit_up$level'] ==
                    null) {
                  users
                      .doc(uid)
                      .set({'sit_up$level': poseReps}, SetOptions(merge: true));
                } else {
                  users.doc(uid).update({'sit_up$level': poseReps});
                }
              }
            } else {
