...
import 'package:google_ml_kit_jumping_jack/google_ml_kit.dart';
// import 'package:workout/pages/all-pose/Model/01_warm_up/warm_counter.dart';
...
class detector_exercises_jumping_jack extends StatefulWidget {
  //เปลี่ยน  detector_exercises
  final bool useClassifier;
  final bool isActivity;
  final int setStep;
  const detector_exercises_jumping_jack({
    //เปลี่ยน  detector_exercises
...
class _PoseDetectorViewState extends State<detector_exercises_jumping_jack> {
                                ...
                                child: Countdown(
                                  ...
                                  onFinished: () async {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            //     detector_exercises_toy_soldier(
                                            //   useClassifier: true,
                                            //   isActivity: true,
                                            // ), //ท่า02
                                            counter_cam(
