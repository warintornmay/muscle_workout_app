...
import 'package:google_ml_kit_balance_arm_swing/google_ml_kit.dart';
import 'package:workout/pages/all-pose/Model/01_warm_up/warm_counter.dart';
...
class detector_exercises_balance extends StatefulWidget {
  //เปลี่ยน  detector_exercises
  final bool useClassifier;
  final bool isActivity;
  final int setStep;
  const detector_exercises_balance({
    //เปลี่ยน  detector_exercises
...
class _PoseDetectorViewState extends State<detector_exercises_balance> {
                                ...
                                child: Countdown(
                                  ...
                                  onFinished: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            //     detector_exercises_arm_circles(
                                            //   useClassifier: true,
                                            //   isActivity: true,
                                            // ), //ท่า02
                                            counter_cam(
