...
import 'package:google_ml_kit_high_knees/google_ml_kit.dart';
...
class detector_exercises_high_knees extends StatefulWidget {
  //เปลี่ยน  detector_exercises
  final bool useClassifier;
  final bool isActivity;
  final int setStep;
  const detector_exercises_high_knees({
    //เปลี่ยน  detector_exercises
...
class _PoseDetectorViewState extends State<detector_exercises_high_knees> {
