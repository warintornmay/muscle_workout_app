...
import 'package:google_ml_kit_sidelying_leg_raises/google_ml_kit.dart';
...
class detector_exercises_sidelying_leg_raises extends StatefulWidget {
  final bool useClassifier;
  final bool isActivity;
  final int level;

  const detector_exercises_sidelying_leg_raises({
...
class _PoseDetectorViewState
    extends State<detector_exercises_sidelying_leg_raises> {
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                //   MaterialPageRoute(
                                //     builder: (context) =>
                                //         //     detector_exercises_donkey_kick(
                                //         //   level: widget.level,
                                //         // ),
                                //         counter_cam(
                                //       level: widget.level,
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) => counter_cam(
          level: widget.level,
          routePoseName: 'detector_exercises_donkey_kick',
        ),
      ),
    );
  }
            ...
            if (documentSnapshot.exists) {
              ...
              if (poseReps != 0) {
                if ((documentSnapshot.data() as Map<String, dynamic>)[
                        'sidelying_leg_raises$level'] ==
                    null) {
                  users.doc(uid).set({'sidelying_leg_raises$level': poseReps},
                      SetOptions(merge: true));
                } else {
                  users
                      .doc(uid)
                      .update({'sidelying_leg_raises$level': poseReps});
                }
              }
            } else {
