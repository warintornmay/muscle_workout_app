...
class _PoseDetectorViewState extends State<detector_exercises_catcow> {
            ...
            if (documentSnapshot.exists) {
              ...
              if (poseReps != 0) {
                if ((documentSnapshot.data()
                        as Map<String, dynamic>)['cat_cow_pose$level'] ==
                    null) {
                  users.doc(uid).set({'cat_cow_pose$level': poseReps},
                      SetOptions(merge: true));
                } else {
                  users.doc(uid).update({'cat_cow_pose$level': poseReps});
                }
              }
            } else {
