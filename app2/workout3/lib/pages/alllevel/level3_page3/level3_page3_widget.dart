import '../../all-pose/Model/04_shoulder_back/counter.dart';
...
import 'level3_page3_model.dart';
export 'level3_page3_model.dart';
import 'package:workout/pages/all-pose/Model/count_waitcam/count_waitcam.dart';

class Level3Page3Widget extends StatefulWidget {
  const Level3Page3Widget({Key? key}) : super(key: key);

  @override
  _Level3Page3WidgetState createState() => _Level3Page3WidgetState();
}

class _Level3Page3WidgetState extends State<Level3Page3Widget> {
  late Level3Page3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Level3Page3Model());
