...
import 'level1_page4_model.dart';
export 'level1_page4_model.dart';
import 'package:workout/pages/all-pose/Model/count_waitcam/count_waitcam.dart';

class Level1Page4Widget extends StatefulWidget {
  const Level1Page4Widget({Key? key}) : super(key: key);

  @override
  _Level1Page4WidgetState createState() => _Level1Page4WidgetState();
}

class _Level1Page4WidgetState extends State<Level1Page4Widget> {
  late Level1Page4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Level1Page4Model());
