import 'package:workout/pages/all-pose/Model/05_legs/counter.dart';
...
import 'level3_page4_model.dart';
export 'level3_page4_model.dart';
import 'package:workout/pages/all-pose/Model/count_waitcam/count_waitcam.dart';

class Level3Page4Widget extends StatefulWidget {
  const Level3Page4Widget({Key? key}) : super(key: key);

  @override
  _Level3Page4WidgetState createState() => _Level3Page4WidgetState();
}

class _Level3Page4WidgetState extends State<Level3Page4Widget> {
  late Level3Page4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Level3Page4Model());
