...
import 'level_page1_model.dart';
export 'level_page1_model.dart';

class LevelPage1Widget extends StatefulWidget {
  const LevelPage1Widget({Key? key}) : super(key: key);

  @override
  _LevelPage1WidgetState createState() => _LevelPage1WidgetState();
}

class _LevelPage1WidgetState extends State<LevelPage1Widget> {
  late LevelPage1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LevelPage1Model());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('Level1_Page1');
                          },
                          text: 'ระดับที่ 1',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('Level2_Page1');
                          },
                          text: 'ระดับที่ 2',
                          options: FFButtonOptions(
                            width: 300.0,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('Level3_Page1');
                        },
                        text: 'ระดับที่ 3',
                        options: FFButtonOptions(
                          width: 300.0,
