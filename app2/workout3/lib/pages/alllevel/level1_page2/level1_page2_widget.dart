...
import 'level1_page2_model.dart';
export 'level1_page2_model.dart';
...
class Level1Page2Widget extends StatefulWidget {
  const Level1Page2Widget({Key? key}) : super(key: key);

  @override
  _Level1Page2WidgetState createState() => _Level1Page2WidgetState();
}

class _Level1Page2WidgetState extends State<Level1Page2Widget> {
  late Level1Page2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Level1Page2Model());
