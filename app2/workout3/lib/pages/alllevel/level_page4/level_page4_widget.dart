...
import 'level_page4_model.dart';
export 'level_page4_model.dart';

class LevelPage4Widget extends StatefulWidget {
  const LevelPage4Widget({Key? key}) : super(key: key);

  @override
  _LevelPage4WidgetState createState() => _LevelPage4WidgetState();
}

class _LevelPage4WidgetState extends State<LevelPage4Widget> {
  late LevelPage4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LevelPage4Model());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('Level1_Page4');
                          },
                          text: 'ระดับที่ 1',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('Level2_Page4');
                          },
                          text: 'ระดับที่ 2',
                          options: FFButtonOptions(
                            width: 300.0,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('Level3_Page4');
                        },
                        text: 'ระดับที่ 3',
                        options: FFButtonOptions(
                          width: 300.0,
