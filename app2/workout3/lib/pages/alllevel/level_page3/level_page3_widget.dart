...
import 'level_page3_model.dart';
export 'level_page3_model.dart';

class LevelPage3Widget extends StatefulWidget {
  const LevelPage3Widget({Key? key}) : super(key: key);

  @override
  _LevelPage3WidgetState createState() => _LevelPage3WidgetState();
}

class _LevelPage3WidgetState extends State<LevelPage3Widget> {
  late LevelPage3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LevelPage3Model());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('Level1_Page3');
                          },
                          text: 'ระดับที่ 1',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('Level2_Page3');
                          },
                          text: 'ระดับที่ 2',
                          options: FFButtonOptions(
                            width: 300.0,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('Level3_Page3');
                        },
                        text: 'ระดับที่ 3',
                        options: FFButtonOptions(
                          width: 300.0,
