...
import 'level2_page3_model.dart';
export 'level2_page3_model.dart';
import 'package:workout/pages/all-pose/Model/count_waitcam/count_waitcam.dart';

class Level2Page3Widget extends StatefulWidget {
  const Level2Page3Widget({Key? key}) : super(key: key);

  @override
  _Level2Page3WidgetState createState() => _Level2Page3WidgetState();
}

class _Level2Page3WidgetState extends State<Level2Page3Widget> {
  late Level2Page3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Level2Page3Model());
