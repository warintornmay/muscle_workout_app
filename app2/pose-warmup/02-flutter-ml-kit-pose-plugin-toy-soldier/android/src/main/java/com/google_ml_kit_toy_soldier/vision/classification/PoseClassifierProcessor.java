package com.google_ml_kit_toy_soldier.vision.classification;
...
import com.google_ml_kit_toy_soldier.vision.PoseDataStorage;
...
public class PoseClassifierProcessor {
    ...
    private static final String POSE_SAMPLES_FILE = "pose/toy_soldier1_csvs_out.csv";
    private static final String POSE_ACTIVITY = "pose/toy_soldier1_csvs_out.csv";
    // private static final String POSE_SAMPLES_FILE =
    // "pose/fitness_poses_csvs_out_without_outliers.csv";
    // private static final String POSE_SAMPLES_FILE =
    // "pose/fitness_poses_csvs_out_with_outliers.csv";
    // private static final String POSE_SAMPLES_FILE =
    // "pose/beginners_poses_csvs_out.csv";
    private static final String RIGHT_CLASS = "Right";
    private static final String LEFT_CLASS = "Left";
    private static final String READY_CLASS = "Ready";
    private static final String[] POSE_CLASSES = {
            RIGHT_CLASS, LEFT_CLASS, READY_CLASS
            // PUSHUPS_CLASS
    };
    ...
    public List<String> getPoseResult(Pose pose) {
        ...
        if (!pose.getAllPoseLandmarks().isEmpty()) {
            ...
            float poseAccuracy = classification.getClassConfidence(maxConfidenceClass)
            ...
            // -----------------------------------------------------------------------------------
            //
            PoseDataStorage.setData(maxConfidenceClass,
                    Double.parseDouble(String.format(Locale.US, "%.2f", poseAccuracy)));
        }
    ...
    public List<String> getPoseResultWithReps(Pose pose) {
        ...
        if (!pose.getAllPoseLandmarks().isEmpty()) {
            ...
            float poseAccuracy = classification.getClassConfidence(maxConfidenceClass)
                    / poseClassifier.confidenceRange();
            System.out.println("#####confidenc = " + poseAccuracy + "cofidence = "
                    + classification.getClassConfidence(maxConfidenceClass) + " +++++===== "
                    + poseClassifier.confidenceRange() + "max = " + maxConfidenceClass);
