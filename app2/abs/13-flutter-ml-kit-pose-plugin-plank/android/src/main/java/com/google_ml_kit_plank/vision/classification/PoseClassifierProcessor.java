...
import com.google_ml_kit_plank.vision.PoseDataStorage;
...
public class PoseClassifierProcessor {
    ...
    private static final String POSE_SAMPLES_FILE = "pose/plank_csvs_out.csv";
    private static final String POSE_ACTIVITY = "pose/plank_csvs_out.csv";

    private static final String PLANK_CLASS = "plank";
    private static final String READY_CLASS = "ready";
    private static final String[] POSE_CLASSES = {
            PLANK_CLASS, READY_CLASS
