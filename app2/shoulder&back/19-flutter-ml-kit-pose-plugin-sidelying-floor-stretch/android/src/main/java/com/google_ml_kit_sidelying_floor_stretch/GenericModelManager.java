package com.google_ml_kit_sidelying_floor_stretch;
...
public class GenericModelManager {
    ...
    // To avoid downloading models in the main thread as they are around 20MB and
    // may crash the app.
    ExecutorService executorService = Executors.newCachedThreadPool();

    public void downloadModel(RemoteModel remoteModel, DownloadConditions downloadConditions,
